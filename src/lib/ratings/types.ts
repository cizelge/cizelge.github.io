...
/** Hocaya sorulan kriterler: başlık, kısa açıklama ve 1-5 karşılıkları. */
export const CRITERION_INFO: Record<Criterion, { label: string; hint: string; scale: readonly string[] }> = {
  clarity: {
    label: "Ders Anlatımı",
    hint: "anlaşılır anlatıyor muydu",
    scale: ["hiç anlaşılmıyordu", "zor anlaşılıyordu", "idare eder", "anlaşılırdı", "çok anlaşılırdı"],
  },
  fairness: {
    label: "Not Dağılımı",
    hint: "notlandırması adil miydi",
    scale: ["hiç adil değildi", "pek adil değildi", "idare eder", "adildi", "çok adildi"],
  },
  helpful: {
    label: "Yardımseverlik",
    hint: "soru sorunca yardımcı olur muydu",
    scale: ["hiç olmazdı", "pek olmazdı", "idare eder", "olurdu", "her zaman olurdu"],
  },
  homework: {
    label: "Ödev Yükü",
    hint: "ne kadar ödev verirdi",
    scale: ["hiç yok denecek kadar az", "az", "orta", "çok", "çok fazla"],
  },
  attendance: {
    label: "Yoklama",
    hint: "yoklama alır mıydı",
