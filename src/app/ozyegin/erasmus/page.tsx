// Erasmus başvurusu (sunucu bileşeni): Erasmus verisini ve hafifletilmiş müfredatları okur;
// uygunluk, puan ve hibe hesabı tarayıcıda, öğrencinin girdiği bilgilerle yapılır.
...
export const metadata: Metadata = {
  title: "Erasmus başvurusu ve hibe hesabı, Özyeğin",
  description:
    "Not ortalamanı ve ELE puanını gir. Özyeğin Erasmus başvuru şartlarını, tahmini Erasmus puanını ve aylık hibeyi gör.",
